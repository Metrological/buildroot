...
KHRONOS_DEPENDENCIES = host-flex host-bison host-dos2unix linux-headers linux libgdl libgma
...
#	ARCH_CFLAGS="$(TARGET_CFLAGS) -v -DEGL_EGLEXT_PROTOTYPES" \
