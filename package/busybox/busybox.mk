...
define BUSYBOX_SET_IPV6
	...
	$(call KCONFIG_ENABLE_OPT,CONFIG_PING6,$(BUSYBOX_BUILD_CONFIG))
	$(call KCONFIG_ENABLE_OPT,CONFIG_TRACEROUTE6,$(BUSYBOX_BUILD_CONFIG))
	$(call KCONFIG_ENABLE_OPT,CONFIG_UDHCPC6,$(BUSYBOX_BUILD_CONFIG))
endef
else
define BUSYBOX_SET_IPV6
