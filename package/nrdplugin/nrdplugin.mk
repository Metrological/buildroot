...
ifeq ($(BR2_PACKAGE_NRDAPPLICATION),y)
  NRDPLUGIN_APP_BUILD = $(TARGET_CONFIGURE_OPTS) $(MAKE) TYPE=$(CPPSDK_BUILDTYPE) -C $(@D)/app build
  NRDPLUGIN_APP_INSTALL_TARGET = $(MAKE) TYPE=$(CPPSDK_BUILDTYPE) -C $(@D)/app target
endif
