...
ifeq ($(BR2_PACKAGE_NRD_PLAYER_SKELETON),y)
	...
	NRD_CMAKE_FLAGS += -DDPI_IMPLEMENTATION=raspberrypi
else ifeq ($(BR2_PACKAGE_NRD_PLAYER_GSTREAMER),y)
	NRD_CMAKE_FLAGS += -DDPI_IMPLEMENTATION=gstreamer
	NRD_DEPENDENCIES += gstreamer1
else ifeq ($(BR2_PACKAGE_NRD_PLAYER_NEXUS),y)
	NRD_CMAKE_FLAGS += -DDPI_IMPLEMENTATION=nexus
	NRD_DEPENDENCIES += bcm-refsw
else ifeq ($(BR2_PACKAGE_NRD_PLAYER_OPENMAX),y)
