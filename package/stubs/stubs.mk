...
ifeq ($(BR2_PACKAGE_DDPSTUB),y)
  STUBS_DDPSTUB_BUILD = $(MAKE) CC=$(TARGET_CC_NOCCACHE) BUILDFLAGS="-mtune=$(BR2_GCC_TARGET_CPU) -mfloat-abi=$(BR2_GCC_TARGET_FLOAT_ABI) -march=$(BR2_GCC_TARGET_ARCH) -fPIC" TYPE=$(STUBS_BUILDTYPE) -C $(@D)/ddpstub build
