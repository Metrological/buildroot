...
ifeq ($(BR2_PACKAGE_CPPSDK_TRACING),y)
  CPPSDK_TRACING_BUILD = $(MAKE) CXX=$(TARGET_CXX) TYPE=$(CPPSDK_BUILDTYPE) -C $(@D)/tracing build
...
ifeq ($(BR2_PACKAGE_CPPSDK_DEVICES),y)
  CPPSDK_DEVICES_BUILD = $(MAKE) CXX=$(TARGET_CXX) TYPE=$(CPPSDK_BUILDTYPE) -C $(@D)/devices build
