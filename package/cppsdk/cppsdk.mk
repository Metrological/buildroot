...
ifeq ($(BR2_PACKAGE_CPPSDK_GENERICS),y)
  CPPSDK_GENERICS_BUILD = $(MAKE) TYPE=$(CPPSDK_BUILDTYPE) CXX=$(TARGET_CXX) -C $(@D)/generics build
...
ifeq ($(BR2_PACKAGE_CPPSDK_WEBSOCKET),y)
  CPPSDK_WEBSOCKET_BUILD = $(MAKE) TYPE=$(CPPSDK_BUILDTYPE) CXX=$(TARGET_CXX) -C $(@D)/websocket build
