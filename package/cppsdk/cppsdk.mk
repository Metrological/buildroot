...
ifeq ($(BR2_PACKAGE_RPI_USERLAND),y)
    CPPSDK_CONF_OPT += -DCPPSDK_PLATFORM=RPI
else ifeq ($(BR2_PACKAGE_BCM_REFSW)$(BR2_arm),yy)
    CPPSDK_CONF_OPT += -DCPPSDK_PLATFORM=EOS
else ifeq ($(BR2_PACKAGE_BCM_REFSW)$(BR2_mipsel),yy)
    CPPSDK_CONF_OPT += -DCPPSDK_PLATFORM=DAWN
else ifeq ($(BR2_PACKAGE_INTELCE_SDK),y)
    CPPSDK_CONF_OPT += -DCPPSDK_PLATFORM=INTELCE
...
ifeq ($(BR2_PACKAGE_CPPSDK_PROFILER),y)
    CPPSDK_CONF_OPT += -DCPPSDK_PROFILER=ON
endif

ifeq ($(BR2_PACKAGE_CPPSDK_RPC),y)
    CPPSDK_CONF_OPT += -DCPPSDK_RPC=ON
endif

ifeq ($(BR2_PACKAGE_CPPSDK_PROCESS),y)
    CPPSDK_CONF_OPT += -DCPPSDK_PROCESS=ON
endif
...
ifeq ($(BR2_PACKAGE_CPPSDK_MQC),y)
    CPPSDK_CONF_OPT += -DCPPSDK_MQC=ON
endif
